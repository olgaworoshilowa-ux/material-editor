...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function qo(e,t,n){let r=new Float32Array(No),i=new W(0,1,0);return new ca({name:`SphericalGaussianBlur`,defines:{n:No,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Xo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Jo(){return new ca({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Xo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Yo(){return new ca({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Xo(),fragmentShader:`
	...
	`}var Zo=class extends Nn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ki(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Il=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},Ll=new Ja(-1,1,1,-1,0,1),Rl=new class extends fi{constructor(){super(),this.setAttribute(`position`,new ei([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new ei([0,2,0,0,2,0],2))}},zl=class{constructor(e){this._mesh=new Pi(Rl,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Ll)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},Bl=class extends Il{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof ca?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=aa.clone(e.uniforms),this.material=new ca({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new zl(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Vl=class extends Il{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Hl=class extends Il{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},Ul=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new U);this._width=n.width,this._height=n.height,t=new Nn(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:be}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Bl(Fl),this.copyPass.material.blending=0,this.timer=new to}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}Vl!==void 0&&(r instanceof Vl?n=!0:r instanceof Hl&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new U);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Wl={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		void main() {
			...
			// color space
				...
				}`})}_getEdgeDetectionMaterial(){return new ca({uniforms:{maskTexture:{value:null},texSize:{value:new U(.5,.5)},visibleEdgeColor:{value:new W(1,1,1)},hiddenEdgeColor:{value:new W(1,1,1)}},vertexShader:`varying vec2 vUv;
				...
				}`})}_getSeparableBlurMaterial(e){return new ca({defines:{MAX_RADIUS:e},uniforms:{colorTexture:{value:null},texSize:{value:new U(.5,.5)},direction:{value:new U(.5,.5)},kernelRadius:{value:1}},vertexShader:`varying vec2 vUv;
				...
				}`})}_getOverlayMaterial(){return new ca({uniforms:{maskTexture:{value:null},edgeTexture1:{value:null},edgeTexture2:{value:null},patternTexture:{value:null},edgeStrength:{value:1},edgeGlow:{value:1},usePatternTexture:{value:0}},vertexShader:`varying vec2 vUv;
				...
				}`,blending:2,depthTest:!1,depthWrite:!1,transparent:!0})}};Kl.BlurDirectionX=new U(1,0),Kl.BlurDirectionY=new U(0,1);var ql=class extends Il{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new q}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}};function Jl(e){return Math.max(0,Math.min(255,e))}function Yl(e){let t=document.createElement(`canvas`);t.width=256,t.height=256;let n=t.getContext(`2d`);n.fillStyle=e,n.fillRect(0,0,256,256);for(let e=0;e<256;e+=2)for(let t=0;t<256;t+=2)n.fillStyle=`rgba(0,0,0,${(14+(Math.sin(t*.35)+Math.cos(e*.4))*.5*8)/255})`,n.fillRect(t,e,1,1);let r=n.getImageData(0,0,256,256);for(let e=0;e<r.data.length;e+=4){let t=(Math.random()-.5)*14;r.data[e]=Jl(r.data[e]+t),r.data[e+1]=Jl(r.data[e+1]+t),r.data[e+2]=Jl(r.data[e+2]+t)}n.putImageData(r,0,0);let i=new qi(t);return i.wrapS=oe,i.wrapT=oe,i.colorSpace=Ct,i.anisotropy=8,i}function Xl(){let e=document.createElement(`canvas`);e.width=512,e.height=512;let t=e.getContext(`2d`),n=[`#d8c3a5`,`#cfb896`,`#e0c9ab`,`#cbb08a`,`#d6be9c`];for(let e=0,r=0;e<512;e+=64,r++){let i=0;for(;i<512;){let a=90+(r*17+i)%70;t.fillStyle=n[(r+Math.floor(i/40))%n.length],t.fillRect(i,e,a-2,62),t.strokeStyle=`rgba(90,70,45,0.18)`,t.strokeRect(i+.5,e+.5,a-2,62),i+=a}}let r=new qi(e);return r.wrapS=oe,r.wrapT=oe,r.repeat.set(3,3),r.colorSpace=Ct,r}function Zl(e,t){return e.userData.slotId=t,e.traverse(e=>{e.userData.slotId=t}),e}function Ql(e,t,n,r,i=.04){let a=new Zi(e,t,n,8,6,8),o=a.attributes.position;for(let r=0;r<o.count;r++){let a=o.getX(r),s=o.getY(r),c=o.getZ(r),l=Math.abs(a),u=Math.abs(s),d=Math.abs(c);if(l>e/2-i&&u>t/2-i){let n=Math.sign(a)*(e/2-i),r=Math.sign(s)*(t/2-i),o=a-n,c=s-r,l=Math.hypot(o,c)||1;a=n+o/l*i,s=r+c/l*i}if(Math.abs(a)>e/2-i&&d>n/2-i){let t=Math.sign(a)*(e/2-i),r=Math.sign(c)*(n/2-i),o=a-t,s=c-r,l=Math.hypot(o,s)||1;a=t+o/l*i,c=r+s/l*i}o.setXYZ(r,a,s,c)}o.needsUpdate=!0,a.computeVertexNormals();let s=new Pi(a,r);return s.castShadow=!0,s.receiveShadow=!0,s}function $l(e,t){let n=new ur,r=Ql(.72,.12,.7,e,.05);r.position.set(0,.42,.02),Zl(r,`fabric`);let i=Ql(.72,.55,.12,e,.055);i.position.set(0,.72,-.3),i.rotation.x=-.08,Zl(i,`fabric`);let a=Ql(.1,.28,.68,e,.04);a.position.set(-.36,.55,0),Zl(a,`fabric`);let o=Ql(.1,.28,.68,e,.04);o.position.set(.36,.55,0),Zl(o,`fabric`),n.add(r,i,a,o);let s=[];for(let[e,r,i]of[[-.28,.18,.26],[.28,.18,.26],[-.28,.18,-.26],[.28,.18,-.26]]){let a=new Pi(new Qi(.022,.028,.36,12),t);a.position.set(e,r,i),a.castShadow=!0,Zl(a,`frame`),n.add(a),s.push(a)}let c=Ql(.7,.06,.66,t,.02);return c.position.set(0,.34,.02),Zl(c,`frame`),n.add(c),s.push(c),{group:n,parts:new Map([[`fabric`,[r,i,a,o]],[`frame`,s]])}}function eu(e){let t=new Pl({canvas:e,antialias:!0,alpha:!1,powerPreference:`high-performance`});t.setPixelRatio(Math.min(window.devicePixelRatio,2)),t.setClearColor(`#f2f2f2`,1),t.shadowMap.enabled=!0,t.shadowMap.type=1,t.outputColorSpace=Ct,t.toneMapping=4,t.toneMappingExposure=1.1;let n=new vr;n.background=new q(`#f2f2f2`);let r=new qa(32,1,.1,50),i=new Fa(16777215,15261650,1);n.add(i);let a=new Xa(16775923,1.5);a.position.set(2.5,4.5,2),a.castShadow=!0,a.shadow.mapSize.set(1024,1024),a.shadow.camera.near=.5,a.shadow.camera.far=12,a.shadow.camera.left=-2.5,a.shadow.camera.right=2.5,a.shadow.camera.top=2.5,a.shadow.camera.bottom=-2.5,a.shadow.bias=-3e-4,n.add(a);let o=new Xa(15266047,.45);o.position.set(-2,2.5,1.5),n.add(o);let s=new ua({map:Xl(),roughness:.78,metalness:.02}),c=new ua({color:`#f7f7f7`,roughness:.95,metalness:0}),l=new Pi(new $i(5,5),s);l.rotation.x=-Math.PI/2,l.receiveShadow=!0,n.add(l);let u=new Pi(new $i(5,2.6),c);u.position.set(0,1.3,-1.4),u.receiveShadow=!0,n.add(u);let d=new Pi(new $i(5,2.6),c);d.position.set(-1.5,1.3,0),d.rotation.y=Math.PI/2,d.receiveShadow=!0,n.add(d);let f=new ua({color:`#b7a0c9`,roughness:.85,metalness:0}),p=new ua({color:`#2f241c`,roughness:.5,metalness:.08}),m=$l(f,p);m.group.position.set(0,0,0),m.group.rotation.y=-.35,n.add(m.group);let h=new Ul(t);h.addPass(new ql(n,r));let g=new Kl(new U(1,1),n,r);return g.edgeStrength=8,g.edgeGlow=.6,g.edgeThickness=2.5,g.pulsePeriod=0,g.visibleEdgeColor.set(`#34c759`),g.hiddenEdgeColor.set(`#34c759`),h.addPass(g),h.addPass(new Gl),{renderer:t,scene:n,camera:r,composer:h,outlinePass:g,parts:m.parts,slotMats:{fabric:f,frame:p},applyGen:{fabric:0,frame:0},chair:m.group,frameId:0,disposed:!1,raycaster:new ho,pointer:new U}}function tu(e){let t=[];for(let n of e)n.traverse(e=>{e instanceof Pi&&t.push(e)});return t}function nu(e,t){let n=e.parts.get(t)??[];e.outlinePass.selectedObjects=tu(n)}function ru(e,t,n,r){let i=e.slotMats[t],a=e.applyGen[t]+=1;if(i.map&&=(i.map.dispose(),null),r.mode===`solid`){i.color.set(r.solidColor),i.needsUpdate=!0;return}let o=Math.max(.25,r.scale/100),s=r.rotation*Math.PI/180;if(n.mapUrl){new Na().load(n.mapUrl,n=>{if(e.disposed||e.applyGen[t]!==a){n.dispose();return}i.map&&i.map.dispose(),n.wrapS=oe,n.wrapT=oe,n.colorSpace=Ct,n.anisotropy=8,n.repeat.set(o*2.2,o*2.2),n.center.set(.5,.5),n.rotation=s,i.map=n,i.color.set(r.tint),i.needsUpdate=!0},void 0,()=>{if(e.disposed||e.applyGen[t]!==a)return;let c=Yl(n.color);c.repeat.set(o*2.2,o*2.2),c.center.set(.5,.5),c.rotation=s,i.map=c,i.color.set(r.tint),i.needsUpdate=!0});return}let c=Yl(n.color);c.repeat.set(o*2.2,o*2.2),c.center.set(.5,.5),c.rotation=s,i.map=c,i.color.set(r.tint),i.needsUpdate=!0}function iu(e){let t=e;for(;t;){if(t.userData.slotId)return t.userData.slotId;t=t.parent}return null}function au({fabricMaterial:e,frameMaterial:t,fabricSettings:n,frameSettings:r,selectedSlot:i,onSelectSlot:a}){let o=(0,l.useRef)(null),s=(0,l.useRef)(null),c=(0,l.useRef)(null),u=(0,l.useRef)(i),d=(0,l.useRef)(a),f=(0,l.useRef)({active:!1,moved:!1,x:0,y:0,yaw:.55,pitch:.12});return(0,l.useEffect)(()=>{u.current=i},[i]),(0,l.useEffect)(()=>{d.current=a},[a]),(0,l.useEffect)(()=>{let e=o.current,t=s.current;if(!e||!t)return;let n=eu(e);c.current=n,nu(n,u.current);let r=new W(0,.5,0),i=()=>{let{yaw:e,pitch:t}=f.current,i=2.55;n.camera.position.set(r.x+Math.sin(e)*Math.cos(t)*i,r.y+Math.sin(t)*i+.35,r.z+Math.cos(e)*Math.cos(t)*i),n.camera.lookAt(r)},a=()=>{let e=Math.max(1,Math.floor(t.clientWidth)),r=Math.max(1,Math.floor(t.clientHeight));e<2||r<2||(n.renderer.setSize(e,r,!1),n.composer.setSize(e,r),n.outlinePass.setSize(e,r),n.outlinePass.resolution.set(e,r),n.camera.aspect=e/r,n.camera.updateProjectionMatrix())};a(),i(),requestAnimationFrame(()=>{a(),nu(n,u.current)});let l=new ResizeObserver(()=>{a()});l.observe(t);let p=()=>{n.disposed||(n.frameId=requestAnimationFrame(p),n.composer.render())};p();let m=t=>{f.current.active=!0,f.current.moved=!1,f.current.x=t.clientX,f.current.y=t.clientY,e.setPointerCapture(t.pointerId)},h=e=>{if(!f.current.active)return;let t=e.clientX-f.current.x,n=e.clientY-f.current.y;Math.abs(t)+Math.abs(n)>3&&(f.current.moved=!0),f.current.x=e.clientX,f.current.y=e.clientY,f.current.yaw-=t*.005,f.current.pitch=pn.clamp(f.current.pitch+n*.003,-.2,.55),i()},g=t=>{let r=f.current.moved;f.current.active=!1;try{e.releasePointerCapture(t.pointerId)}catch{}if(r)return;let i=e.getBoundingClientRect();if(!i.width||!i.height)return;n.pointer.x=(t.clientX-i.left)/i.width*2-1,n.pointer.y=-((t.clientY-i.top)/i.height)*2+1,n.raycaster.setFromCamera(n.pointer,n.camera);let a=[];for(let e of n.parts.values())a.push(...e);let o=n.raycaster.intersectObjects(a,!0);if(!o.length)return;let s=iu(o[0].object);s&&d.current(s)};return e.addEventListener(`pointerdown`,m),e.addEventListener(`pointermove`,h),e.addEventListener(`pointerup`,g),()=>{n.disposed=!0,cancelAnimationFrame(n.frameId),l.disconnect(),e.removeEventListener(`pointerdown`,m),e.removeEventListener(`pointermove`,h),e.removeEventListener(`pointerup`,g),Object.values(n.slotMats).forEach(e=>{e.map?.dispose(),e.dispose()}),n.composer.dispose(),n.renderer.dispose(),c.current=null}},[]),(0,l.useEffect)(()=>{let e=c.current;e&&nu(e,i)},[i]),(0,l.useEffect)(()=>{let t=c.current;t&&ru(t,`fabric`,e,n)},[e,n]),(0,l.useEffect)(()=>{let e=c.current;e&&ru(e,`frame`,t,r)},[t,r]),(0,D.jsxs)(`main`,{className:`viewport`,children:[(0,D.jsx)(`div`,{className:`viewport__canvas-wrap`,ref:s,children:(0,D.jsx)(`canvas`,{ref:o,className:`viewport__canvas`})}),(0,D.jsx)(`p`,{className:`viewport__hint`,children:`Click fabric or frame · drag to orbit`})]})}var ou=[{id:`f1`,name:`Linen Soft`,category:`Fabric`,color:`#D4C4B0`,pattern:`fabric`,slot:`fabric`},{id:`f2`,name:`Velvet Cocoa`,category:`Fabric`,color:`#6B4E3D`,pattern:`fabric`,slot:`fabric`},{id:`f3`,name:`Velvet Lavender`,category:`Fabric`,color:`#B7A0C9`,pattern:`fabric`,slot:`fabric`},{id:`f4`,name:`Boucle Cream`,category:`Fabric`,color:`#E8DFD2`,pattern:`fabric`,slot:`fabric`},{id:`f5`,name:`Wool Charcoal`,category:`Fabric`,color:`#4A4A4A`,pattern:`fabric`,slot:`fabric`},{id:`f6`,name:`Cotton Sage`,category:`Fabric`,color:`#A8B5A0`,pattern:`fabric`,slot:`fabric`},{id:`f7`,name:`Leather Tan`,category:`Leather`,color:`#A67C52`,pattern:`leather`,slot:`fabric`},{id:`f8`,name:`Leather Espresso`,category:`Leather`,color:`#3E2A1F`,pattern:`leather`,slot:`fabric`},{id:`f9`,name:`Suede Blush`,category:`Fabric`,color:`#C9A9A6`,pattern:`fabric`,slot:`fabric`},{id:`w1`,name:`Walnut Dark`,category:`Wood`,color:`#5C4033`,pattern:`wood`,slot:`frame`},{id:`w2`,name:`Oak Natural`,category:`Wood`,color:`#C4A574`,pattern:`wood`,slot:`frame`},{id:`w3`,name:`Ebony`,category:`Wood`,color:`#2F241C`,pattern:`wood`,slot:`frame`},{id:`w4`,name:`Ash Light`,category:`Wood`,color:`#D2C2A8`,pattern:`wood`,slot:`frame`},{id:`w5`,name:`Teak Warm`,category:`Wood`,color:`#8B5E3C`,pattern:`wood`,slot:`frame`},{id:`m1`,name:`Brushed Steel`,category:`Metal`,color:`#9AA0A6`,pattern:`metal`,slot:`frame`},{id:`m2`,name:`Matte Black`,category:`Metal`,color:`#222222`,pattern:`metal`,slot:`frame`},{id:`m3`,name:`Brass Soft`,category:`Metal`,color:`#C4A35A`,pattern:`metal`,slot:`frame`},{id:`p1`,name:`Plastic White`,category:`Plastic`,color:`#F3F1EC`,pattern:`concrete`,slot:`frame`},{id:`x1`,name:`Marble Carrara`,category:`Stone`,color:`#E8E4DF`,pattern:`concrete`,slot:`frame`},{id:`x2`,name:`Concrete Pale`,category:`Stone`,color:`#B8B5B0`,pattern:`concrete`,slot:`frame`},{id:`x3`,name:`Glass Clear`,category:`Glass`,color:`#C5D8E8`,pattern:`metal`,slot:`frame`},{id:`x4`,name:`Terrazzo Soft`,category:`Stone`,color:`#D9CFC4`,pattern:`concrete`,slot:`fabric`}];function su(e,t){let n={wood:`radial-gradient(circle at 32% 28%, #ffffffaa 0%, transparent 28%),
           radial-gradient(circle at 50% 50%, ${e} 0%, ${cu(e,-35)} 70%, #1a1a1a 100%),
           repeating-linear-gradient(95deg, transparent 0 3px, #00000018 3px 4px)`,fabric:`radial-gradient(circle at 32% 28%, #ffffff99 0%, transparent 26%),
             radial-gradient(circle at 50% 50%, ${e} 0%, ${cu(e,-30)} 72%, #111 100%),
             repeating-linear-gradient(0deg, transparent 0 2px, #00000012 2px 3px)`,metal:`radial-gradient(circle at 30% 25%, #ffffffcc 0%, transparent 22%),
            radial-gradient(circle at 70% 70%, #00000055 0%, transparent 45%),
            linear-gradient(135deg, ${cu(e,40)}, ${e}, ${cu(e,-40)})`,leather:`radial-gradient(circle at 32% 28%, #ffffff77 0%, transparent 26%),
              radial-gradient(circle at 50% 50%, ${e} 0%, ${cu(e,-35)} 70%, #1a1008 100%)`,concrete:`radial-gradient(circle at 32% 28%, #ffffff88 0%, transparent 28%),
               radial-gradient(circle at 50% 50%, ${e} 0%, ${cu(e,-20)} 75%, #333 100%)`};return n[t]??n.fabric}function cu(e,t){let n=e.replace(`#`,``),r=parseInt(n,16),i=Math.min(255,Math.max(0,(r>>16)+t)),a=Math.min(255,Math.max(0,(r>>8&255)+t)),o=Math.min(255,Math.max(0,(r&255)+t));return`#${(i<<16|a<<8|o).toString(16).padStart(6,`0`)}`}var lu=ou.map(e=>({id:e.id,name:e.name,category:e.category,color:e.color,slot:e.slot,preview:su(e.color,e.pattern)}));function uu(e){return lu.filter(t=>t.slot===e)}var du=`folder-uploads`;function fu(){let e=uu(`fabric`),t=uu(`frame`),[n,r]=(0,l.useState)([{id:du,name:`Uploads`}]),[i,a]=(0,l.useState)(du),[o,s]=(0,l.useState)([]),[c,u]=(0,l.useState)([]),[d,f]=(0,l.useState)([e[2]?.id??e[0].id,t[2]?.id??t[0].id]),[p,m]=(0,l.useState)(`fabric`),[h,g]=(0,l.useState)(e[2]?.id??e[0].id),[_,v]=(0,l.useState)(t[2]?.id??t[0].id),[y,b]=(0,l.useState)({...ee,solidColor:e[2]?.color??e[0].color}),[x,S]=(0,l.useState)({...ee,solidColor:t[2]?.color??t[0].color}),[C,w]=(0,l.useState)([]),[T,E]=(0,l.useState)([]),te=(0,l.useMemo)(()=>[...o,...lu],[o]),j=(0,l.useMemo)(()=>te.filter(e=>e.slot===p),[te,p]),ne=te.find(e=>e.id===h)??e[0],re=te.find(e=>e.id===_)??t[0],ie=(0,l.useMemo)(()=>A.find(e=>e.id===p)??A[0],[p]),oe=p===`fabric`?ne:re,P=p===`fabric`?y:x,se=p===`fabric`?h:_,F=()=>({selectedSlot:p,fabricId:h,frameId:_,fabricSettings:y,frameSettings:x}),ce=()=>{w(e=>[...e.slice(-29),F()]),E([])},le=e=>{m(e.selectedSlot),g(e.fabricId),v(e.frameId),b(e.fabricSettings),S(e.frameSettings)},ue=e=>{u(t=>[e,...t.filter(t=>t!==e)].slice(0,9)),f(t=>t.includes(e)?t:[e,...t].slice(0,12))};return(0,D.jsx)(`div`,{className:`app`,children:(0,D.jsxs)(`div`,{className:`app__body`,children:[(0,D.jsx)(au,{fabricMaterial:ne,frameMaterial:re,fabricSettings:y,frameSettings:x,selectedSlot:p,onSelectSlot:e=>{ce(),m(e)}}),(0,D.jsx)(k,{objectName:`Chair fluffy fluff`,onBack:()=>window.history.back(),onSave:()=>window.alert(`Saved\nFabric: ${ne.name}\nFrame: ${re.name}`),onEyedropper:()=>window.alert(`Eyedropper: click a material in the scene`)}),(0,D.jsx)(M,{slot:p,suggestedMaterials:j,allMaterials:te,customMaterials:o,folders:n,selectedId:se,recentIds:c,usedIds:d,activeFolderId:i,onSelect:e=>{ce(),ue(e);let t=te.find(t=>t.id===e),n={...ee,mode:`texture`,solidColor:t?.color??ee.solidColor};p===`fabric`?(g(e),b(n)):(v(e),S(n))},onUpload:e=>{let t=URL.createObjectURL(e),n={id:`custom-${Date.now()}`,name:e.name.replace(/\.[^.]+$/,``)||`My texture`,category:p===`fabric`?`Fabric`:`Wood`,color:`#888888`,preview:`url(${t})`,slot:p,mapUrl:t,isCustom:!0,folderId:i};ce(),s(e=>[n,...e]),ue(n.id);let r={...ee,mode:`texture`,solidColor:n.color};p===`fabric`?(g(n.id),b(r)):(v(n.id),S(r))},onCreateFolder:e=>{let t=`folder-${Date.now()}`;r(n=>[...n,{id:t,name:e}]),a(t)},onSelectFolder:a},p),(0,D.jsx)(N,{selectedSlot:p,onSelect:e=>{ce(),m(e)},fabricPreview:y.mode===`solid`?y.solidColor:ne.mapUrl?`url(${ne.mapUrl}) center / cover`:ne.preview,framePreview:x.mode===`solid`?x.solidColor:re.mapUrl?`url(${re.mapUrl}) center / cover`:re.preview}),(0,D.jsx)(ae,{material:oe,settings:P,selectedSlot:ie,onChange:e=>{ce(),p===`fabric`?b(e):S(e)},onResetMaterial:()=>{ce(),p===`fabric`?(g(e[0].id),b({...ee,solidColor:e[0].color})):(v(t[0].id),S({...ee,solidColor:t[0].color}))}}),(0,D.jsx)(O,{onUndo:()=>{w(e=>{if(!e.length)return e;let t=e[e.length-1];return E(e=>[F(),...e]),le(t),e.slice(0,-1)})},onRedo:()=>{E(e=>{if(!e.length)return e;let[t,...n]=e;return w(e=>[...e,F()]),le(t),n})},canUndo:C.length>0,canRedo:T.length>0})]})})}(0,u.createRoot)(document.getElementById(`root`)).render((0,D.jsx)(l.StrictMode,{children:(0,D.jsx)(fu,{})}));